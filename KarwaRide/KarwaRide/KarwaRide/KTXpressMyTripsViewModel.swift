//
//  KTXpressMyTripsViewModel.swift
//  KarwaRide
//
//  Created by Satheesh on 9/8/21.
//  Copyright © 2021 Karwa. All rights reserved.
//

import UIKit

class KTXpressMyTripsViewModel: KTBaseViewModel {
    ...
    private func fetchBookingsFromDB() {
        ...
        let historyBooking : [KTBooking] = KTBookingManager().historyXpressBookings()
