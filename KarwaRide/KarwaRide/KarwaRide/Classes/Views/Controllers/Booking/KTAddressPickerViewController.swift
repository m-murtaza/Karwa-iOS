...
class KTAddressPickerViewController: KTBaseViewController,
    ...
    public weak var previousNewView : KTKarwaPlanTripViewmodel?

    var fromPlanTrip = false
  ...
  private func toggleSkipButton() {
    ...
    func navigateToPreviousView(pickup: Any?, dropOff: Any?) {
        if xpressLocation == false {
            if pickup != nil {
                if previousView == nil {
                    previousNewView?.setPickAddress(pAddress: pickup as! KTGeoLocation)
                } else {
            ...
            if dropOff != nil {
                if previousView == nil {
                    previousNewView?.setDropAddress(dAddress: dropOff as! KTGeoLocation)
                } else {
            ...
            previousNewView?.delegate?.dismiss()
        } else {
